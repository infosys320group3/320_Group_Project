...
public class DataConnect : MonoBehaviour
{
    ...
    //string WebsiteURL = "https://dwhi045.azurewebsites.net/tables/Astronaut?zumo-api-version=2.0.0";

    string WebsiteURL = "https://dwhi320.azurewebsites.net/tables/AstronautsOnMoon?zumo-api-version=2.0.0";
    ...
    void Start()
    {
        ...
        //Astronaut[] Astronauts = JsonReader.Deserialize<Astronaut[]>(jsonResponse);
        Astronaut[] Astronauts = JsonConvert.DeserializeObject<Astronaut[]>(jsonResponse);
        ...
        foreach (Astronaut Astronaut in Astronauts)
        {
            ...
            Debug.Log("This Astronauts name is: " + Astronaut.AstronautName);
            //----------------------
